...
if(!$paternoUsu) {
  ...
  if(empty($errores)) {
    // INSERTAR EN LA BD
  $query = "INSERT INTO Usuarios (idUsuarios, nombreUsu, paternoUsu, maternoUsu, correoUsu, contrasenaUsu, rol) VALUES ( '$idUsuarios', '$nombreUsu', '$paternoUsu', '$maternoUsu', '$correoUsu', '$contrasenaUsu', '$rol' )";
...
document.addEventListener('keydown', function(event) {
  ...
  <div class="col-md-6">
      ...
      <label for="contrasenaUsu">Contraseña</label>
        <input type="password" class="form-control text-uppercase" name="contrasenaUsu" id="contrasenaUsu" placeholder="**********" value="<?php echo $contrasenaUsu; ?>">
