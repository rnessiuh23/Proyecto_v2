...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $idDependencias = $_POST['idDependencias'];
...
if(!$jefe) {
  ...
  if(empty($errores)) {
    // INSERTAR EN LA BD
  $query = "INSERT INTO Dependencias (idDependencias, nombreDep, correoDep, telefonoDep, jefe, sector, denominacion) VALUES ( '$idDependencias', '$nombreDep', '$correoDep', '$telefonoDep', '$jefe', '$sector', '$denominacion' )";
