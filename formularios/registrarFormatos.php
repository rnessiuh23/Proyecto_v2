...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if(empty($errores)) {
    // INSERTAR EN LA BD
  $query = "INSERT INTO Formatos (idFormatos, fecRegistro, hora, ss, fecInicio, fecTermino, carta, primerInf, segundoInf, tercerInf, finalInf, terminacion, evaluacion, solicitud, observaciones) 
  VALUES ( '$idFormatos', '$fecRegistro', '$hora', '$ss', '$fecInicio', '$fecTermino', '$carta', '$primerInf', '$segundoInf', '$tercerInf', '$finalInf', '$terminacion', '$evaluacion', '$solicitud', '$observaciones')";
